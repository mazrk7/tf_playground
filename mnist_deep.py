...
# Stride one convolutions and zero padded so that output is same size as input
def conv2d(x, W):
...
# Initialise weights with a small bit of noise for symmetry breaking and to prevent 0 gradients
...
def main(_):
  ...
  with tf.Session() as sess:
    ...
    for i in range(20000):
      # Get a 'batch' of 50 random data points from training set each loop iteration
