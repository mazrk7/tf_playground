...
def create_vrnn(
  ...
  return TrainableVRNN(rnn_cell, data_encoder, latent_encoder, transition,
      emission, proposal_type, proposal=proposal, rev_rnn_cell=rev_rnn_cell, random_seed=random_seed)
